...
void easyppm_read(PPM* ppm, const char* path) {
    ...
    dummy = fscanf(fp, "%2s\n", itypestr);
    // Skipe over comments (i.e. GIMP-generated PGM has a comment before width and height)
    // TODO: We want to remove comments potentially from other lines too
    char line[1000];
    do {
